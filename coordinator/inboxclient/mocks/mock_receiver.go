...
//
//	mockgen -source messagereceiver_test.go -destination=mocks/mock_receiver.go -package=mocks github.com/Kimenzo/any-sync/coordinator/inboxclient MessageReceiverTest
//
