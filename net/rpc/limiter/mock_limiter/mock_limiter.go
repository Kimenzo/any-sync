...
// Source: github.com/Kimenzo/any-sync/net/rpc/limiter (interfaces: RpcLimiter)
//
// Generated by this command:
//
//	mockgen -destination mock_limiter/mock_limiter.go github.com/Kimenzo/any-sync/net/rpc/limiter RpcLimiter
//
