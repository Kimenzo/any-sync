...
// Source: github.com/Kimenzo/any-sync/net/pool (interfaces: Pool,Service)
//
// Generated by this command:
//
//	mockgen -destination mock_pool/mock_pool.go github.com/Kimenzo/any-sync/net/pool Pool,Service
//
...
func (mr *MockPoolMockRecorder) Flush(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flush", reflect.TypeOf((*MockPool)(nil).Flush), ctx)
}
