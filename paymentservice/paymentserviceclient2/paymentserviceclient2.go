//go:generate mockgen -destination=mock/mock_paymentserviceclient2.go -package=mock_paymentserviceclient2 github.com/Kimenzo/any-sync/paymentservice/paymentserviceclient2 AnyPpClientServiceV2
