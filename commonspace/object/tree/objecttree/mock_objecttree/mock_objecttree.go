...
// Source: github.com/Kimenzo/any-sync/commonspace/object/tree/objecttree (interfaces: ObjectTree,Storage)
//
// Generated by this command:
//
//	mockgen -destination mock_objecttree/mock_objecttree.go github.com/Kimenzo/any-sync/commonspace/object/tree/objecttree ObjectTree,Storage
//
...
func (m *MockStorage) GetAfterAddSeq(ctx context.Context, addSeq uint64, iter objecttree.StorageIterator) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAfterAddSeq", ctx, addSeq, iter)
	ret0, _ := ret[0].(error)
	return ret0
}

// GetAfterAddSeq indicates an expected call of GetAfterAddSeq.
