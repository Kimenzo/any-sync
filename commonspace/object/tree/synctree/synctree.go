//go:generate mockgen -destination mock_synctree/mock_synctree.go github.com/Kimenzo/any-sync/commonspace/object/tree/synctree SyncTree,HeadNotifiable,SyncClient,RequestFactory
package synctree
